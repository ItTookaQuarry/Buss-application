...
<ClientResultPage Filtredbuses={tabletodisplaytouser[1]} data={tabletodisplaytouser[0]} pagetodisplay={pagetodisplay} tab={tabletodisplaytouser[2]} linktab={`result?start=${searchParams.start}&koniec=${searchParams.koniec}`} />
